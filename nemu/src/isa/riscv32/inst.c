...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  //mersenne.c
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11",mulh,R,int32_t a = src1; int32_t b = src2; int64_t tmp = (int64_t)a * (int64_t)b; R(rd) = BITS(tmp, 63, 32));// R(rd)=(int32_t)(((int64_t)src1*(int64_t)src2)>>32)
